...
const Dashboard = () => {
    ...
    const [equipoDeTrabajo, setEquipoDeTrabajo] = useState([]);
        ...
        fetch(`${API_URL}/api/expedientes`)
                .then(res => res.json())
                .then(data => setExpedientes(Array.isArray(data) ? data : (data.expedientes || [])))
                .catch(() => setExpedientes([]));
            // Equipo de trabajo
        fetch(`${API_URL}/api/equipoDeTrabajo`)
                .then(res => res.json())
                .then(data => setEquipoDeTrabajo(Array.isArray(data) ? data : (data.equipoDeTrabajo || data.agentes || [])))
                .catch(() => setEquipoDeTrabajo([]));
        }, []);
    const [productos] = useState(['Autos', 'Vida', 'Daños', 'Equipo pesado', 'Embarcaciones', 'Ahorro']);
    ...
    const resumen = useMemo(() => ({
        ...
        totalEquipo: equipoDeTrabajo.length,
        equipoActivo: equipoDeTrabajo.filter(m => m.activo).length,
    ...
    }), [expedientes, equipoDeTrabajo, productosPersonalizados, productos]);
    ...
    const importarDatos = useCallback((event) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                if (!datos.expedientes || !datos.equipoDeTrabajo) {
                ...
                if (confirm('¿Está seguro de importar estos datos? Se sobrescribirán los datos actuales.')) {
                    ...
                    setEquipoDeTrabajo(datos.equipoDeTrabajo || datos.agentes || []);
    ...
    const exportarDatos = useCallback(() => {
        ...
        linkElement.click();
    }, [expedientes, equipoDeTrabajo, productosPersonalizados]);
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="row text-center">
                                ...
                                <div className="col-6 col-md-2">
                                    <h4 className="text-info">{resumen.totalEquipo}</h4>
                                    <p className="text-muted mb-0">Equipo Total</p>
                                </div>
                                <div className="col-6 col-md-2">
                    ...
                    <div className="col-12">
                        <div className="card border-dashed border-2">
                            <div className="card-body text-center py-5">
                                ...
                                <p className="text-muted">Para comenzar, explora los diferentes módulos del sistema</p>
