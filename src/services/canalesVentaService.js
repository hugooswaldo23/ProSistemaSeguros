...
export const obtenerCanalesVenta = async () => {
  try {
    const response = await fetch(`${API_URL}/api/canalesVenta`, { headers: getAuthHeaders() });
...
export const obtenerCanalesVentaActivos = async () => {
  try {
    const response = await fetch(`${API_URL}/api/canalesVenta/activos`, { headers: getAuthHeaders() });
...
export const obtenerCanalVentaPorId = async (id) => {
  try {
    const response = await fetch(`${API_URL}/api/canalesVenta/${id}`, { headers: getAuthHeaders() });
